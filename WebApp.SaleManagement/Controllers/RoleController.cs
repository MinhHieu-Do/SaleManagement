...
namespace WebApp.SaleManagement.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(RoleManager<IdentityRole> roleManager, INotyfService notyf)
        {
            _notyf = notyf;
        ...
        public IActionResult Filter(string searchString)
        {
            ...
            var roles =_roleManager.Roles.Select(s => new RoleViewModel
            {
                Id = s.Id,
                Name = s.Name
            }).ToList();
            ...
            return PartialView("_ListCustomer", roles);
        }
